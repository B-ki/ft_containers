...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/20 17:49:58 by rmorel            #+#    #+#             */
/*   Updated: 2023/04/20 17:52:55 by rmorel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
NS::map<T1, T2> mp;
NS::map<T1, T2>::iterator it = mp.end();

void	ft_find(T1 const &k)
{
	NS::map<T1, T2>::iterator ret = mp.find(k);
...
void mli_find(void)
{
	...
	NS::map<T1, T2> const c_map(mp.begin(), mp.end());
